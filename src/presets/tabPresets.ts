...
export const effectsPresets: EffectsPreset[] = [
  ...
  },
  {
    name: 'Blockbuster',
    icon: '🎬',
    description: 'Hollywood Teal & Orange + Cinematic Bloom',
    params: {
      blur: 0,
      bloom: 0,
      bloomThreshold: 0.6,
  ...
  },
  {
    ...
    icon: '🌃',
    description: 'Neon LUT + Radial Blur + Extreme Bloom',
    params: {
      blur: 2,
      bloom: 0,
      bloomThreshold: 0.5,
      ...
      displacementTime: 0,
      displacementAngle: 0,
      colorLUT: 'cool-cyberpunk',
      colorLUTIntensity: 0.9,
      mirrorMode: 'none',
      mirrorPosition: 0.5,
    },
  },
  {
    ...
    icon: '🌀',
    description: 'Feedback Echo + Rotation + Zoom',
    params: {
      blur: 1,
      bloom: 0,
      bloomThreshold: 0.65,
  ...
  },
  {
    name: 'Mandala Magic',
    icon: '🔮',
    description: 'Kaleidoscope + Mirror Quad + Bloom',
    params: {
      blur: 1,
      bloom: 0,
      bloomThreshold: 0.6,
  ...
  },
  {
    name: 'Liquid Fractal',
    icon: '🌊',
    description: 'Displacement + Kaleidoscope + Feedback',
    params: {
      blur: 2,
      bloom: 0,
      bloomThreshold: 0.7,
  ...
  },
  {
    name: 'Rorschach',
    icon: '🦋',
    description: 'Perfect Symmetry + Organic Displacement',
    params: {
      blur: 1.5,
      bloom: 0,
      bloomThreshold: 0.7,
  ...
  },
  {
    name: 'Tunnel Vision',
    icon: '🎯',
    description: 'Extreme Radial Blur + Feedback Zoom',
    params: {
      blur: 0,
      bloom: 0,
      bloomThreshold: 0.6,
  ...
  },
  {
    name: 'Golden Hour',
    icon: '🌅',
    description: 'Warm Vintage LUT + Soft Bloom',
    params: {
      blur: 3,
      bloom: 0,
      bloomThreshold: 0.65,
      ...
      displacementTime: 0,
      displacementAngle: 0,
      colorLUT: 'warm-vintage',
      colorLUTIntensity: 0.8,
      mirrorMode: 'none',
      mirrorPosition: 0.5,
    },
  },
  {
    name: 'War Film',
    icon: '⚔️',
    description: 'Bleach Bypass + Gritty Vignette',
    params: {
      blur: 0,
      bloom: 0,
      bloomThreshold: 0.8,
  ...
  {
    name: 'Recursive Mandala',
    icon: '🕉️',
    description: 'Kaleidoscope + Feedback + Displacement',
    params: {
      blur: 1,
      bloom: 0,
      bloomThreshold: 0.6,
  ...
  },
  {
    name: 'Warp Speed',
    icon: '🚀',
    description: 'Radial Blur + Feedback + Motion Blur',
    params: {
      blur: 2,
      bloom: 0,
      bloomThreshold: 0.5,
