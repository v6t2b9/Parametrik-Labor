...
export const letterboxPresets: LetterboxPreset[] = [
  {
    name: 'Subtle',
    icon: '🌙',
    description: 'Sanfte Wellen, dezente Interferenz',
    params: {
      enabled: true,
      useAgentColor: true,
      useTrailIntensity: true,
      useForceVector: true,
      agentColorWeight: 0.5,
      trailIntensityWeight: 0.3,
      forceVectorWeight: 0.2,
      propagationSpeed: 1.5,
      decayRate: 0.97,
      diffusionRate: 0.2,
      interferenceEnabled: true,
      interferenceType: 'both',
      waveLength: 30,
      coherenceLength: 80,
      blendMode: 'alpha',
      brightness: 1.2,
  ...
  },
  {
    name: 'Vivid',
    icon: '🌈',
    description: 'Lebendige Farben, starke Interferenz',
    params: {
      enabled: true,
      useAgentColor: true,
      useTrailIntensity: true,
      useForceVector: true,
      agentColorWeight: 2.0,
      trailIntensityWeight: 1.0,
      forceVectorWeight: 0.5,
  ...
  },
  {
    name: 'Waves',
    icon: '🌊',
    description: 'Ozean-artige Wellen mit hoher Diffusion',
    params: {
      enabled: true,
      useAgentColor: true,
      useTrailIntensity: true,
      useForceVector: false,
      agentColorWeight: 1.5,
      trailIntensityWeight: 0.8,
      forceVectorWeight: 0.1,
  ...
  },
  {
    name: 'Double-Slit',
    icon: '⚛️',
    description: 'Klassisches Doppelspalt-Experiment',
    params: {
      enabled: true,
      useAgentColor: true,
      useTrailIntensity: false,
      useForceVector: false,
      agentColorWeight: 1.0,
      trailIntensityWeight: 0.0,
      forceVectorWeight: 0.0,
  ...
  },
  {
    name: 'Lava',
    icon: '🔥',
    description: 'Langsame, dickflüssige Bewegung',
    params: {
      enabled: true,
      useAgentColor: true,
      useTrailIntensity: true,
      useForceVector: true,
      agentColorWeight: 1.2,
      trailIntensityWeight: 1.5,
      forceVectorWeight: 0.8,
  ...
  },
  {
    name: 'Pulse',
    icon: '💓',
    description: 'Schnelle Impulse, kurze Lebensdauer',
    params: {
      enabled: true,
      useAgentColor: true,
      useTrailIntensity: false,
      useForceVector: true,
      agentColorWeight: 2.5,
      trailIntensityWeight: 0.0,
      forceVectorWeight: 1.5,
  ...
  },
  {
    name: 'Meditation',
    icon: '🧘',
    description: 'Beruhigend, langsame Bewegung, weich',
    params: {
      enabled: true,
      useAgentColor: true,
      useTrailIntensity: true,
      useForceVector: false,
      agentColorWeight: 0.8,
      trailIntensityWeight: 0.6,
      forceVectorWeight: 0.1,
